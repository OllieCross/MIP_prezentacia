...
\title{Využitie hier a programov virtuálnej reality ako didaktickej pomôcky v školstve
}
...
Ešte pred prehľadom prezentácie sa zvyčajne uvádza motivácia.
...
\begin{frame}[fragile=singleslide]\frametitle{Môj nový slajd}
	\begin{itemize}
	\item Odrážka prvej úrovne
	\item Odrážka prvej úrovne
		\begin{itemize}
...
\begin{frame}[fragile=singleslide]\frametitle{Môj druhý nový slajd}
	\begin{itemize}
	\item Odrážka prvej úrovne
		\begin{itemize}
		\item Odrážka druhej úrovne
...
\begin{frame}[fragile=singleslide]\frametitle{Druhý slajd len s obrázkom}
	\includegraphics[scale=.15]{obrazok.jpeg}
	\end{frame}
